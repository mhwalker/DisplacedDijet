...
process.setName_("DJ")
from DisplacedDijet.DisplacedJetAnlzr.DJ_options_cff import options
options = options()
...
from DisplacedDijet.DisplacedJetAnlzr.DJ_nTuple_cfi import DJ
import DisplacedDijet.DisplacedJetAnlzr.DJ_ProcessAdjustments_cfi as adjust
